    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-sky-900 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white/95 backdrop-blur rounded-2xl shadow-2xl p-8">
          <h2 className="text-lg font-semibold text-slate-800 mb-6">Student Registration</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input className="input" type="email" required value={form.email}
                onChange={e => setForm(f => ({ ...f, email: e.target.value }))} placeholder="m.curie@university.edu" />
            </div>
            <div>
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            ...
            <Link href="/auth/login" className="text-sky-600 hover:text-sky-700 font-medium hover:underline">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
